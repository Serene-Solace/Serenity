...
export interface CustomFilesUploadProps {
  isDisabled?: boolean;
...
const FilesUpload = forwardRef<HTMLInputElement, CustomFilesUploadProps>(
  (
    {
      onChange,
      color,
        ...
        for (const file of files) {
          if (imgUploader) {
            ...
            if (file.size > MAX_FILE_SIZE_BYTES) {
              setErrorMessage(
                `Image file size exceeds ${MAX_FILE_SIZE_MB}MB limit.`
              );
              return;
            }
          }
      ...
      <StyledWrapper flexDirection={flexDirection}>
        <div className="upload-icon-container">
          <input
            ...
            id="actual-btn"
            accept={
              imgUploader ? ".jpg,.jpeg" : ".pdf,.txt,.docx,.jpg,.jpeg,.png"
            }
